...
/**
 无参路由注册(必须严格按照项目目录路径注册!!!!!!!!!)
 */
- (void)registerModuleNoParameters {
    [[JLRoutes globalRoutes] addRoute:@"/:ModuleA/:target/:Modal" handler:^BOOL(NSDictionary<NSString *,id> * _Nonnull parameters) {
...
/**
 有参路由注册(必须严格按照项目目录路径注册!!!!!!!!!)
 */
- (void)registerModuleParameters {
    [[JLRoutes globalRoutes] addRoute:@"/:ModuleA/:target/:Modal/:parameter" handler:^BOOL(NSDictionary<NSString *,id> * _Nonnull parameters) {
